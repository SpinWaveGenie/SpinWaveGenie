...
void OneDimensionalGaussian::setFWHM(double InFWHM) { FWHM = InFWHM; }

void OneDimensionalGaussian::setTolerance(double InTolerance) { Tolerance = InTolerance; }

double OneDimensionalGaussian::getMinimumEnergy() { return -1.0 * getMaximumEnergy(); }
...
double OneDimensionalGaussian::getExponentialFactor() { return -4.0 * log(2.0) / pow(FWHM, 2); }
