...
image_array = np.loadtxt('YFeO3_2_K_m2.mat')
E_array = np.loadtxt('YFeO3_2_K_m2.y')
x_axis = np.loadtxt('YFeO3_2_K_m2.x')
...
fig.colorbar(im);
plt.savefig('YFeO3_2_K_m2.png',dpi=400,bbox_inches='tight')
plt.close()
