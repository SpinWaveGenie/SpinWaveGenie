...
image_array = np.loadtxt('YFeO3_3_0_L.mat')
E_array = np.loadtxt('YFeO3_3_0_L.y')
x_axis = np.loadtxt('YFeO3_3_0_L.x')

print len(image_array)
print len(image_array[0])
print np.max(image_array)
im = ax.pcolorfast(x_axis[:,2],E_array,image_array,vmin=0.0,vmax=0.1)
...
fig.colorbar(im);
plt.savefig('YFeO3_3_0_L.png',dpi=400,bbox_inches='tight')
plt.close()
