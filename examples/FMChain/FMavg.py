...
im = ax.imshow(image_array,interpolation='bicubic',origin='lower',aspect=0.5,extent=[x_axis[0,2]/(2.0*np.pi),x_axis[-1,2]/(2.0*np.pi),E_array[0],E_array[-1]],vmin=0.0,vmax=0.3)
